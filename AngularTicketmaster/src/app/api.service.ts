...
export class APIService {
  apiURL =
    'https://app.ticketmaster.com/discovery/v2/events.json?apikey=3s3A0oZm22CsOcaUT6JjbUXQlEb2EuyL';
  ...
  searchEvents(searchParameters: any) {
    ...
    if (searchParameters.classificationName.length > 0) {
      requestParameters.classificationName =
        searchParameters.classificationName;
    }
